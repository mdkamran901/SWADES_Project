...
public class Delete_obs_data {
	...
	public static void get_ObsDataHRall() {
		...
		Response response =
				...
				.queryParams("stationId", "138")
				.queryParams("frequency", "4").queryParams("month", "12").queryParams("year", "2001")

						.log().all().delete(SwadesAPIsEndPoints.Delete_obs_data);
